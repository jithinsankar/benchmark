...
You can install the `benchmark` package using pip:
...
The benchmark results, including system information and task-specific metrics, will be printed to the console.

## Project Structure

- `src/benchmark/benchmark_runner.py`: The main script to run the benchmark.
- `src/benchmark/ollama_manager.py`: Handles Ollama installation, server management, and model pulling.
- `src/benchmark/sys_info.py`: Collects detailed system hardware information.
- `src/benchmark/benchmark_tasks.py`: Defines the benchmark tasks.
- `src/benchmark/result_formatter.py`: (If applicable) Formats the benchmark results.
